...
nos toca terminar de rematar los exámenes finales.
 ¡Y toca un poco de matemáticas! 😱

A una función se le pasan dos parámetros: 
...
Como a veces pueden haber más de dos valores que sumen, 
se devolverá el primero empezando por la izquierda que encuentre otro par,
...
function sumPairs(numbers = [], result = Number) {
  for (let i = 0; i < numbers.length; i++) {
    for (let j = 0; j < numbers.length; j++) {
      if (i !== j && numbers[j] + numbers[i] === result) {
